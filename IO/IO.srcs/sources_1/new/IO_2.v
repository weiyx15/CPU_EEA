...
//    wire [7:0] W[7:0];          //IO端口映射网线型变量
    ...
    assign IO0 = (io_write==1&&addr==0)? Din:8'bz;
    assign IO1 = (io_write==1&&addr==1)? Din:8'bz;
    assign IO2 = (io_write==1&&addr==2)? Din:8'bz;
    assign IO3 = (io_write==1&&addr==3)? Din:8'bz;
    assign IO4 = (io_write==1&&addr==4)? Din:8'bz;
    assign IO5 = (io_write==1&&addr==5)? Din:8'bz;
    assign IO6 = (io_write==1&&addr==6)? Din:8'bz;
    assign IO7 = (io_write==1&&addr==7)? Din:8'bz;
